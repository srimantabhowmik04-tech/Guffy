...
class GuffyFeedScreen extends StatefulWidget {
  const GuffyFeedScreen({super.key});

  @override
  State<GuffyFeedScreen> createState() => _GuffyFeedScreenState();
}

class _GuffyFeedScreenState extends State<GuffyFeedScreen> {
  ...
  final List<Map<String, dynamic>> posts = [
    {
      ...
      'content': 'Welcome to Guffy! The next-gen social media app is live 🚀',
      'likes': 12,
      'comments': 3,
    },
    {
      'author': 'Rahul Sharma',
      'content': 'Loving the clean UI of Guffy! Great work team.',
      'likes': 8,
      'comments': 1,
    }
  ];
